...
const pin_size_t PIN_PA_EN = 12;  // to R_EN (1st IBT-2 module)
const pin_size_t PIN_PA = 13;     // to RPWM (1st IBT-2 module)
const pin_size_t PIN_PB_EN = 14;  // to L_EN (1st IBT-2 module)
const pin_size_t PIN_PB = 15;     // to LPWM (1st IBT-2 module)
const pin_size_t PIN_PC_EN = 16;  // to R_EN (2nd IBT-2 module)
const pin_size_t PIN_PC = 17;     // to RPWM (2nd IBT-2 module)
